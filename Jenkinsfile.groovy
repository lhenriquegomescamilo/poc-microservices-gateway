...
podTemplate(
    ...
    node('poc-microservices-gateway') {
        def REPOSITORY
        def GIR_URL_REPOSITORY = 'git@github.com:lhenriquegomescamilo/poc-microservices-gateway.git'
        def DOCKER_IMAGE = "gateway_gateway"
        def DOCKER_IMAGE_VERSION = ""
        def MICROSERVICE_NAME = "gateway"
